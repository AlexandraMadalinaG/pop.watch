...
export function Movies() {
  ...
  const API_KEY = "6045cd5d809cfddb1291fe5497117e40"
  ...
  return (
    ...
    <div className="movies-app">
      <header className="center-max-size header-movies">
        <span className={"brand"}>Hello! It's time for a new mooovie</span>
        <form className="form-movies" onSubmit={fetchMovies}>
          <input className="search-movies" type="text" placeholder="Your favourite movie" id="search"
